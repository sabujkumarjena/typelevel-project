...
object Http4s extends IOApp.Simple {
  ...
  object CourseRepository {
    ...
    private val catsEffectCourse = Course(
      "7485b83f-c2b5-4515-8bc4-35cd7ab25256",
      "Scala course",
      2022,
      List("Sabuj", "Saikat", "Anuj", "Anupam"),
      "Martin Odersky"
    )
  ...
  // GET localhost:8080/courses/7485b83f-c2b5-4515-8bc4-35cd7ab25256/students
    ...
    HttpRoutes.of[F] {
      ...
      case GET -> Root / "courses" / UUIDVar(courseId) / "students" =>
        CourseRepository.findCoursesById(courseId).map(_.students) match {
          case Some(students) =>
            Ok(students.asJson, Header.Raw(CIString("My-custom-header"), "allevite"))
